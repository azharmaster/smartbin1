...
<head>
    ...
    <style>
    /* ==================================================================== */
    /* === SmartBin Admin Theme — clean, professional, responsive ========= */
    /* ==================================================================== */
    :root {
        --sb-bg: #f4f6fa;
        --sb-surface: #ffffff;
        ...
        --sb-primary: #672d84;
        --sb-primary-soft: rgba(103, 45, 132, 0.08);
    ...
    .main-header.navbar .dropdown-menu .dropdown-divider {
        margin: 4px 0;
    ...
    /* On small screens disable the zoom hack so content remains readable */
    ...
    @media (max-width: 991.98px) {
        ...
        /* DataTables toolbar wraps cleanly on tablet */
        .dataTables_wrapper .top {
            flex-direction: column;
            align-items: stretch;
            gap: 8px;
